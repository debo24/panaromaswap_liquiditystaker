...
import PanaromaswapV2ERC20 from 'panaromaswap_v2core/build/ERC20.json'
...
export async function stakingRewardsFixture([wallet]: Wallet[]): Promise<StakingRewardsFixture> {
  ...
  const stakingToken = await deployContract(wallet, PanaromaswapV2ERC20, [expandTo18Decimals(1000000)])
